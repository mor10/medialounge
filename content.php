    ...
    <div class="poster-content">
        ...
        <footer class="poster-footer">
            ...
            <div class="poster-nav control clear">
                <div class="poster-trailer"><a href="#" class="trailer-trigger" data-bind="/medialounge/wp-content/videos/trailers/<?php echo the_field('video_slug'); ?>trailer.mp4" title="Play trailer"><i class="fa fa-play"></i> Trailer</a></div>
                <div class="poster-full"><a href="#" class="movie-trigger" data-bind="/medialounge/wp-content/videos/movies/<?php echo the_field('video_slug'); ?>.mp4" title="Play full movie"><i class="fa fa-play"></i> Full</a></div>
            </div>
        </footer>
    </div>
